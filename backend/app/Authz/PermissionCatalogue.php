...
final class PermissionCatalogue
{
    ...
    public static function definitions(): array
    {
        $tenant = [
            ...
            ['purchases.edit', 'Edit purchase drafts', 'purchases', null],
            ['purchases.post', 'Post purchases', 'purchases', null],
            ['purchases.void', 'Void purchases', 'purchases', null],
            ['purchase_returns.view', 'View purchase returns', 'purchases', null],
            ['purchase_returns.create', 'Create purchase returns', 'purchases', null],
            ['purchase_returns.edit', 'Edit purchase return drafts', 'purchases', null],
            ['purchase_returns.post', 'Post purchase returns', 'purchases', null],
            ['inventory.view', 'View inventory', 'inventory', null],
            ['inventory.opening_balance.view', 'View opening balances', 'inventory', null],
            ['inventory.opening_balance.create', 'Create opening balances', 'inventory', null],
            ['inventory.opening_balance.edit', 'Edit opening balances', 'inventory', null],
            ['inventory.opening_balance.post', 'Post opening balances', 'inventory', null],
    ...
    public static function keysForSystemRole(string $code): array
    {
        return match ($code) {
            ...
            self::MANAGER => [
                ...
                'inventory.view',
                'inventory.opening_balance.view',
                'inventory.opening_balance.create',
                'inventory.opening_balance.edit',
